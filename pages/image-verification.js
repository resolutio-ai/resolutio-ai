import { Box, CircularProgress, Container, Grid, ImageList, ImageListItem, ImageListItemBar, TextField } from "@mui/material";
  ...
  return (
    <Box sx={{minHeight:'70vh'}}>
      ...
      <Box sx={{ flexGrow: 1, margin: '15px 0 15px', width: '97%' }}>
        <TextField id="outlined-basic" columns={{ xs: 12, md: 12 }} sx={{ width: '100%' }} label="Image URL" variant="outlined"
          value={imageURL}
