      ...
      <div className='flex w-full flex-col items-center gap-5 md:flex-row'>
        ...
        <nav className='flex-0 justify-end'>
          <div className='grid grid-flow-col gap-4 '>
            ...
            >
              <Image src='/discord.svg' alt='' width={30} height={10} />
            </a>
            <a
              target='_blank'
              rel='noopener'
            ...
            >
              <Image src='/twitter.svg' alt='' width={30} height={10} />
            </a>
            <a
              target='_blank'
              rel='noopener'
            ...
            >
              <Image src='/linkedin.svg' alt='' width={30} height={10} />
            </a>
            <a
              target='_blank'
              rel='noopener'
            ...
            >
              <Image src='/email.svg' alt='' width={30} height={10} />
            </a>
          </div>
        </nav>
      </div>
